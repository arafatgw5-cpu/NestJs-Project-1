...
const Profile = () => {
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-6 flex items-center justify-center">
      {/* Card */}
      <div className="w-full max-w-4xl bg-white rounded-3xl shadow-xl p-6 md:p-10 transition hover:shadow-2xl">
        ...
        <div className="mt-10 flex justify-center md:justify-end">
          <button className="btn btn-primary rounded-full px-6 hover:scale-105 transition">
            ✏️ Edit Profile
          </button>
        </div>
      </div>
